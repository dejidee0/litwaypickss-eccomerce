                ...
                <div className="container mx-auto px-4">
                  <div className="max-w-4xl">
                    ...
                    <div className="space-y-6">
                      <h1
                        className={`text-4xl md:text-6xl lg:text-7xl font-bold text-white leading-tight transition-all duration-700 ${
                          index === current
                            ? "translate-y-0 opacity-100"
                      ...
                      <h2
                        className={`text-xl md:text-3xl lg:text-4xl font-medium text-orange-200 transition-all duration-700 ${
                          index === current
                            ? "translate-y-0 opacity-100"
                            : "translate-y-8 opacity-0"
                        }`}
                      ...
                      <p
                        className={`text-lg md:text-xl text-gray-200 max-w-2xl leading-relaxed transition-all duration-700 ${
                          index === current
                            ? "translate-y-0 opacity-100"
                            : "translate-y-8 opacity-0"
                        }`}
